...
## Следующий логичный шаг: эпик 07 и далее по PRD

Эпик **06** (наблюдатель) закрыт по чеклисту в **`docs/business/epic-06-spectator.md`**. Детали протокола — **`docs/dev/API.md`**.

Зависимости: эпики **07–09** — по PRD; эпики **01–06** закрыты в `main`.
...
- [ ] Открыть следующий **`docs/business/epic-NN-*.md`** по PRD (например **`epic-07-chat.md`**) и чеклист.
...
> Продолжи Tennis 1v1 со следующего эпика по PRD. Прочитай `docs/dev/AGENT_HANDOFF.md` и соответствующий `docs/business/epic-NN-*.md`. В `main` уже эпики 01–06.
